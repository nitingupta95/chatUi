...
export function LoginForm() {
    ...
    return (
        <motion.div initial="hidden" animate="visible" className="relative z-10 w-full max-w-md border-border/50 border-2 rounded-xl bg-white">
            <motion.div custom={0} variants={fadeUp} className="glass-card rounded-2xl p-8 space-y-6">
                <motion.div custom={1} variants={fadeUp} className="text-center space-y-3">
                    <Link to="/" className="inline-flex items-center gap-2.5 text-xl font-bold text-foreground">
                        <span className="flex h-9 w-9 px-8 items-center justify-center rounded-xl bg-primary text-primary-foreground text-sm font-extrabold shadow-lg shadow-primary/25">
                            AURA
                        </span>
